...
export const FALLBACK_NEWS: ApiNewsItem[] = [
  ...
  {
    slug: "trung-tam-do-kiem-phat-thanh-truyen-hinh-va-thong-tin-dien-tu-hop-tac-chien-luoc-voi-nutifood-nham-dao-tao-nguon-nhan-luc-truyen-thong-so",
    source_url: "https://kol.gov.vn/tin-tuc/trung-tam-do-kiem-phat-thanh-truyen-hinh-va-thong-tin-dien-tu-hop-tac-chien-luoc-voi-nutifood-nham-dao-tao-nguon-nhan-luc-truyen-thong-so",
    category: "Hoạt động cục",
    title: "Trung tâm Đo kiểm phát thanh truyền hình và thông tin điện tử Hợp tác chiến lược với Nutifood nhằm đào tạo nguồn nhân lực truyền thông số.",
    excerpt: "Ngày 24/7, tại TPHCM, Trung tâm Đo kiểm Phát thanh, Truyền hình và Thông tin điện tử - Cục Phát thanh, truyền hình và Thông tin điện tử (Bộ Văn hóa Thể thao và Du lịch) ký kết thỏa thuận hợp tác chiến lược cùng Công ty Cổ phần Thực phẩm Dinh dưỡng Nutifood.",
  ...
  },
  {
    ...
    category: "Tin tức nổi bật",
    title: "Cục Phát thanh, truyền hình và Thông tin điện tử ra mắt Cổng thông tin điện tử và cơ sở dữ liệu về nhà sáng tạo nội dung số và quảng cáo trực tuyến Việt Nam - kol.gov.vn",
    excerpt: "Trong bối cảnh kinh tế số và các nền tảng mạng xã hội phát triển mạnh mẽ, hoạt động sáng tạo nội dung số ngày càng đóng vai trò quan trọng trong truyền thông, quảng cáo và thương mại điện tử.",
  ...
  },
  {
    ...
    category: "Sự kiện",
    title: "Đấu tranh với thông tin sai lệch, khẳng định vai trò của báo chí chính thống: Bài 2 - Tin giả hoành hành và vai trò “hàng rào miễn dịch” của báo chí chính thống",
    excerpt: "VHO - Tin giả, thông tin sai lệch và các luận điệu xuyên tạc đang lan truyền với tốc độ chưa từng có trên không gian mạng, tác động trực tiếp đến nhận thức của người dân và niềm tin xã hội.",
    published_date: "2026-07-16",
    reading_minutes: 10,
